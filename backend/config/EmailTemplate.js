...
<head>
  ...
  <title>BOOKNEST Password Reset</title>
</head>
  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); margin: 40px auto;">
    <tr>
      <td style="background-color: #1e40af; padding: 20px; text-align: center; border-top-left-radius: 8px; border-top-right-radius: 8px;">
        <h1 style="color: #ffffff; font-size: 24px; margin: 0;">BOOKNEST</h1>
      </td>
    </tr>
    <tr>
      <td style="padding: 40px 20px; text-align: center;">
        ...
        <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
          We received a request to reset the password for your BOOKNEST account associated with <strong>{{email}}</strong>.
        </p>
        <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
    ...
    <tr>
      <td style="background-color: #f1f5f9; padding: 20px; text-align: center; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
        <p style="color: #64748b; font-size: 12px; margin: 0;">
          If you didn’t request a password reset, please ignore this email or contact our support team at <a href="mailto:support@booknest.com" style="color: #1e40af; text-decoration: none;">support@booknest.com</a>.
        </p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>BOOKNEST Email Verification</title>
</head>
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f7fa;">
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); margin: 40px auto;">
    <tr>
    ...
    <tr>
      <td style="padding: 40px 20px; text-align: center;">
        ...
        <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
          Enter this OTP on the verification page to activate your BOOKNEST account.
        </p>
        <p style="color: #dc2626; font-size: 14px; font-weight: bold; margin: 20px 0 0;">
    ...
    <tr>
      <td style="background-color: #f1f5f9; padding: 20px; text-align: center; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px;">
        <p style="color: #64748b; font-size: 12px; margin: 0;">
          If you didn’t sign up for a BOOKNEST account, please ignore this email or contact our support team at <a href="mailto:support@booknest.com" style="color: #1e40af; text-decoration: none;">support@booknest.com</a>.
        </p>
        <p style="color: #64748b; font-size: 12px; margin: 10px 0 0;">
          &copy; 2025 BOOKNEST. All rights reserved.
        </p>
