    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {!isEmailSent &&
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm' >
          <h1 className=' text-indigo-300 text-2xl font-semibold text-center mb-4'>Reset Password</h1>
      ...
      {!isOtpSubmitted && isEmailSent &&
        <form onSubmit={onsubmitOTP} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          <h1 className=' text-indigo-300 text-2xl font-semibold text-center mb-4'>Reset password OTP</h1>
      ...
      {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm' >
          <h1 className=' text-indigo-300 text-2xl font-semibold text-center mb-4'>Enter New Password</h1>
